        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center px-4 py-3 text-white font-medium rounded-lg focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              style={{ backgroundColor: '#ed6e26' }}
              onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#d45d1f'}
              onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#ed6e26'}
            >
              {loading ? (
