/*
  # Corrigir view vw_leads_followup para incluir company_id

  1. Alterações
    - Recriar a view vw_leads_followup para incluir company_id corretamente
...
-- Drop existing view
DROP VIEW IF EXISTS vw_leads_followup CASCADE;

-- Recreate view with company_id
CREATE OR REPLACE VIEW vw_leads_followup AS
SELECT 
  l.id,
